export default {
  translation: {
    ...
    startup: {
      initializing: "サーバーを起動中",
      wait: "これには約1分かかる場合があります。",
      info: "このアプリケーションは、<0></0> でホストされている無料サーバー上にあり、使用されていないときにスリープ状態になります。そのため、再起動時にかなりの遅延が発生します。ご理解いただきありがとうございます。"
    },
    mobileAuthPendingView: {
      received: "があなたのリクエストを受け取りました",
      denied: "があなたのリクエストを拒否しました",
      ignored: "があなたのリクエストに応答していません",
      sending: "リクエストを送信中",
      nonReceived: "誰もあなたのリクエストを受け取っていないようです...",
      verifyConnection: "両方のデバイスがインターネットに接続されていること、および使用しているコードが最新であることを確認してください。",
